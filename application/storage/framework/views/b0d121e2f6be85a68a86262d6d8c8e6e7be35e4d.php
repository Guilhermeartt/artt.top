    ...
    <div class="scroll-sidebar" id="main-scroll-sidebar">
        ...
        <nav class="sidebar-nav" id="main-sidenav">
            <ul id="sidebarnav" data-modular-id="main_menu_team">
                ...
                <!--msg-whatsapp-->
                <?php if(config('visibility.modules.whatsapp')): ?>
                <li data-modular-id="main_menu_team_whatsapp"
                    class="sidenav-menu-item <?php echo e($page['mainmenu_whatsapp'] ?? ''); ?> menu-tooltip menu-with-tooltip"
                    title="<?php echo e(cleanLang(__('lang.whatsapp'))); ?>">
                    <a class="waves-effect waves-dark p-r-20" href="/whatsapp" aria-expanded="false" target="_self">
                        <i class="ti-mobile"></i>
                        <span class="hide-menu"><?php echo e(cleanLang(__('lang.whatsapp'))); ?>
